...
class ForgotPasswordScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Escuchar cambios en el estado para manejar el éxito (retrasar para no ejecutar durante build)
    ref.listen<ForgotPasswordState>(forgotPasswordProvider, (previous, next) {
      if (next.isSuccess && !next.isLoading && context.mounted) {
        final emailParaDialogo = next.email;
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          showDialog(
            ...
            builder: (dialogContext) => AlertDialog(
              ...
              title: Text(l10nDialog.emailSent),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                    l10nDialog.emailSentMessage,
              ...
              actions: [
                DSButton.primary(
                  label: l10nDialog.authUnderstood,
                  onPressed: () {
              ...
              children: [
                ...
                FadeInUp(
                  ...
                  child: DSButton.primary(
                    label: l10n.authSendRecoveryLink,
                    icon: Iconsax.send_2,
                    onPressed:
                        emailController.text.isNotEmpty &&
                            !forgotPasswordState.isLoading
                        ? () => _handleSendResetLink(context, ref)
                        : null,
  ...
  Future<void> _handleSendResetLink(BuildContext context, WidgetRef ref) async {
    ...
    try {
      ...
      if (context.mounted) {
        final l10n = AppLocalizations.of(context)!;
        String errorMessage = l10n.errorSendingLink;
